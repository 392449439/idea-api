...
class OrderController extends Controller
{
	public function create(Request $request)
	{
		...
		$is_open_dada = $request->domainInfo->is_dada === 1;
		...
		$orderInfo['freight_price'] = $queryDeliverFee ? $queryDeliverFee['result']['fee'] : 0;
		...
		$orderInfo['delivery_no'] = $queryDeliverFee ? $queryDeliverFee['result']['deliveryNo'] : '';

		if ($queryDeliverFee) {
			$price += $queryDeliverFee['result']['fee'];
		}
